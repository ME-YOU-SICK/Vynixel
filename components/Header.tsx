...
const Header: React.FC = () => {
  return (
    <header className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between p-4 bg-gray-900 bg-opacity-50 backdrop-blur-sm">
      ...
      <button className="flex items-center px-4 py-2 space-x-2 text-sm font-medium text-white transition-colors bg-white bg-opacity-10 rounded-lg hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-indigo-500">
